        ...
        <div className={cx("page-container", "container-fluid")}>
            <div className={cx("ticket-wrapper")}>
                    ...
                    <div className={cx("left-panel")}>
                        ...
                        <div className={cx("pricing-summary")}>
                            ...
                            {bookingDetails.pointsDiscount > 0 && (
                                <div className={cx("price-row", "discount")}>
                                    <span>
                                        Giảm từ điểm ({bookingDetails.pointsUsed?.toLocaleString("vi-VN")} điểm)
                                    </span>
                ...
                <div className={cx("ticket-actions")}>
                    <CustomizeButton secondary onClick={() => window.print()}>
                        <i className="fas fa-print"></i> In vé
                    </CustomizeButton>
                    <CustomizeButton primary onClick={() => navigate("/booking/history")}>
