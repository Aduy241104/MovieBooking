...
export const UserPage = ({ userText, userFilter }) => {
    ...
    useEffect(() => {
        setBreadcrumbItems([{ title: "Trang chủ", href: "/admin" }, { title: "Người dùng" }, { title: `${userText}` }]);
    ...
    useEffect(() => {
        ...
        const handleFilterMember = debounce(() => {
            ...
            if (searchUser) {
                filters.push(
                    sfOr([sfLike(sfLower("email"), `*${searchTerm}*`), sfLike(sfLower("fullName"), `*${searchTerm}*`)])
                );
            }
            ...
            console.log("Filters applied:", filters.toString());
            console.log("Filter applied:", filter.toString());
        ...
        <>
            ...
            >
                ...
                {isLoading ? (
                    ...
                    <UserTable userText={userText} userRole={userRole} />
                )}
            </div>
