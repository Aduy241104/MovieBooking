...
//               </h2>
//               <Row gutter={[0, 8]} className="">
//                 <Col span={24}><p className="text-bg"><strong className="text-gray-500">Số hàng:</strong> {room.rows}</p></Col>
//                 <Col span={24}><p className="text-bg"><strong className="text-gray-500">Số cột:</strong> {room.cols}</p></Col>
//                 <Col span={24}><p className="text-bg"><strong className="text-gray-500">Tổng ghế:</strong> {room.seats.length}</p></Col>
//               </Row>
