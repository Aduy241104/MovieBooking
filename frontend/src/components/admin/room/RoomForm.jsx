...
//         {/* Left Column: Info */}
//         <div className="flex-grow-1  p-4 rounded-3 shadow">
...
//         <div className="flex-grow-2  p-4 rounded-3 shadow w-100">
//           <div className="text-center  fw-bold py-2 mb-3 rounded bg-danger">
//             Màn hình
//           </div>
