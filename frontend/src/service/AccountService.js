...
const fetchAllAccountAPI = (page, size, filter) => {
    const URL_BACKEND = `/admin/accounts?page=${page}&size=${size}&filter=${filter}&sort=accountId,asc`;
    return axios.get(URL_BACKEND);
}

const fetchAccountByIdAPI = (accountId) => {
    const URL_BACKEND = `/admin/accounts/${accountId}`;
    return axios.get(URL_BACKEND);
}

const updateAccountQuickAPI = (accountId, dataToUpdate) => {
    const URL_BACKEND = `/admin/accounts`;
    const data = {
        accountId,
        ...dataToUpdate
    }
...
const updateAccountStatusAPI = (accountId, status) => {
    const URL_BACKEND = `/admin/accounts/status`;
    const data = {
        accountId,
        status
    }
...
const deleteAccountAPI = (accountId) => {
    const URL_BACKEND = `/admin/accounts/is-deleted`;
    const data = {
        accountId,
        isDelete: true
    }
...
const updateAccountAvatarAPI = (accountId, file) => {
    const URL_BACKEND = `/admin/accounts/${accountId}/avatar`;
