...
const fetchAllFareTypesAPI = (page, size, filter) => {
  let URL_BACKEND = `/admin/fare-types?page=${page}&size=${size}&sort=id,asc`;
...
const fetchAllActiveFareTypesAPI = () => {
  const URL_BACKEND = `/admin/fare-types/getAll`;
  return axios.get(URL_BACKEND);
};

const createFareTypeAPI = (fareType) => {
  const URL_BACKEND = `/admin/fare-types/create`;
  const data = {
    ...fareType,
  };
...
const updateFareTypeAPI = (id, fareType) => {
  const URL_BACKEND = `/admin/fare-types/update/${id}`;
  const data = {
    ...fareType,
  };
...
const deleteFareTypeAPI = (id) => {
  const URL_BACKEND = `/admin/fare-types/is-deleted/${id}`;
