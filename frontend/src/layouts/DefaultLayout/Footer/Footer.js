...
function Footer() {
    return (
        <div className="container-fluid" style={ { backgroundColor: "#0F111A" } }>
            <div className="row pt-5 pb-5 mt-5 ms-5">
                <div className="col-6 text-light">
                    ...
                    <div className="pb-3">
                        <button className="rounded-5 bg-midnight-2 me-3" style={ { width: "40px", height: '40px' } }>
                    ...
                    <p className="fs-7 text-secondary">RoPhim – Phim hay cả rổ - Trang xem phim online chất lượng cao miễn phí
