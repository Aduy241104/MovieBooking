...
// */
// public String buildContextForIntent(QuestionAnalyzer.QueryInfo info, String
// originalQuestion) {
...
// return "Phim '" + movie.getNameVN() + "' (" + movie.getNameEN() + ") sẽ khởi
// chiếu từ ngày: "
// + movie.getFromDate().format(dateFormatter);
// } else {
// return "Hiện tại chưa có thông tin ngày khởi chiếu cho phim này trong hệ
// thống.";
// }
// } else {
...
// context.append("PHIM THỂ LOẠI
// ").append(info.genre.toUpperCase()).append(":\n");
// for (MovieType mt : movieTypes) {
// Movie m = mt.getMovie();
// context.append(" - ").append(m.getNameVN()).append("
// (").append(m.getNameEN()).append(")\n");
// }
// } else {
// return "Hiện tại chưa có phim nào thuộc thể loại " + info.genre + " trong hệ
// thống.";
// }
// }
...
// chatbotMovieRepository.findNowShowingMovies(LocalDate.now());
// if (!nowShowing.isEmpty()) {
// int count = 1;
// context.append("PHIM ĐANG CHIẾU:\n");
// for (Movie movie : nowShowing) {
// context.append(count).append(". ").append(movie.getNameVN()).append("
...
// if (!info.movie_info) {
// context.append("\nBạn muốn xem thông tin chi tiết, lịch chiếu hay đặt vé cho
// phim nào không?");
// }
// context.append("\n");
// }
...
// chatbotMovieRepository.findComingSoonMovies(LocalDate.now());
...
// context.append(" Giá cơ bản: ").append(String.format("%,d",
// fare.getBasePrice().intValue()))
// .append(" VND\n");
// context.append(" Giá theo ngày: ").append(String.format("%,d",
// fare.getDayPrice().intValue()))
// .append(" VND\n");
...
// context.append(" (Đơn tối thiểu: ").append(String.format("%,d",
// promo.getMinOrder().intValue()))
// .append(" VND)");
// }
// context.append("\n");
// }
...
// context.append("HƯỚNG DẪN ĐẶT VÉ CHO PHIM
// '").append(info.movieName.toUpperCase()).append("':\n\n");
...
// context.append("**Lưu ý:** Sau khi đặt vé thành công, không thể đổi suất
// chiếu hoặc hủy vé.\n");
// } else {
// context.append("Rất tiếc, hiện tại không có lịch chiếu cho phim
// '").append(info.movieName)
...
// context.append("Bạn muốn đặt vé cho phim nào? Hãy cho tôi biết tên phim
// nhé!\n");
// }
// }
...
// String movieInfoContext = handleSpecificMovieQuery(info, new
// StringBuilder());
...
// context.append(
// "Bạn vui lòng cung cấp tên phim để xem thông tin chi tiết nhé (ví dụ: 'thông
// tin phim The Batman').\n");
// }
// }
...
// return "ĐỊA CHỈ RẠP:\nMovieTheater Cinema\nĐịa chỉ: 600 Nguyễn Văn Cừ (nối
// dài), P. An Bình, Q. Ninh Kiều, TP. Cần Thơ\n";
// }

// // 11. Liên hệ hỗ trợ
// if (info.contact_support) {
// return "LIÊN HỆ:\nHotline: 1900-6069\nEmail:
// support@movietheater.com\nWebsite: www.movietheater.com";
// }
...
// } else if (lowerQuestion.contains("đăng ký") || lowerQuestion.contains("đăng
// kí") ||
...
// } else if (lowerQuestion.contains("cập nhật") ||
// lowerQuestion.contains("chỉnh sửa") ||
...
// context.append("\nVui lòng cung cấp thêm thông tin về việc bạn cần hỗ
// trợ.\n");
// }
// }
...
// return "Hiện tại chưa có thông tin này trong hệ thống. Tôi chỉ có thể hỗ trợ
// về: phim đang chiếu, lịch chiếu, đặt vé, bảng giá, khuyến mãi, địa chỉ rạp và
// quản lý tài khoản.";
// }
...
// private String handleShowTimesQuery(QuestionAnalyzer.QueryInfo info,
...
// chatbotScreeningRepository.findScreeningsByMovieKeyword(
...
// .append(" (Phòng
// ").append(screening.getCinemaRoom().getCinemaRoomName()).append(")\n");
// }
// } else {
...
// // Lịch chiếu hôm nay
// List<Screening> todayScreenings =
// chatbotScreeningRepository.findTodayScreenings(LocalDateTime.now());
...
// context.append("• Tổng số ghế: ").append(totalSeats != null ? totalSeats :
// 0).append("\n");
...
// .append(" - ").append(room.getSeatQuantity()).append(" ghế (Loại:
// ").append(type).append(")");
// if (fareMatch != null) {
// context.append(" - Giá cơ bản: ").append(String.format("%,d",
// fareMatch.getBasePrice().intValue()))
// .append(" VND");
// }
// context.append("\n");
// }
...
// context.append("**Lưu ý:** Giá vé có thể thay đổi theo ngày trong tuần và
// khung giờ chiếu.\n");

// return context.toString();
// }

// private String handleSpecificMovieQuery(QuestionAnalyzer.QueryInfo info,
// StringBuilder context) {
// List<Movie> foundMovies = findMoviesByName(info.movieName);
// if (!foundMovies.isEmpty()) {
// Movie movie = foundMovies.getFirst();
// context.append("THÔNG TIN PHIM
// **").append(movie.getNameVN()).append("**:\n");
...
// List<Screening> screenings =
// chatbotScreeningRepository.findByMovieName(info.movieName,
// LocalDateTime.now());
// if (!screenings.isEmpty()) {
...
// // Chuẩn hóa input: bỏ dấu, lowercase, loại bỏ khoảng trắng thừa, ký tự đặc
// biệt
