...
public interface BookingRepository extends JpaRepository<Booking, Long> {
         ...
         * @return Total revenue for the specified booking status.
         */
        @Query(value = """
        ...
        /**
         * Get daily ticket revenue and ticket count within a date range.
         *
         * @param fromDate Start date for filtering.
         * @param toDate   End date for filtering.
         * @return List of daily ticket revenue and ticket count.
         */
        @Query(value = """
                SELECT
        ...
        /**
         * Get weekly ticket revenue and ticket count within a date range.
         *
         * @param fromDate Start date for filtering.
         * @param toDate   End date for filtering.
         * @return List of weekly ticket revenue and ticket count.
         */
        @Query(value = """
                        SELECT
        ...
        /**
         * Get monthly ticket revenue and ticket count within a date range.
         *
         * @param fromDate Start date for filtering.
         * @param toDate   End date for filtering.
         * @return List of monthly ticket revenue and ticket count.
         */
        @Query(value = """
                        SELECT
         ...
         * @return List of recently booked tickets.
         */
        @Query("""
        ...
        @Query("SELECT COUNT(b) FROM Booking b " +
                        ...
                        "WHERE b.account.accountId = :accountId AND m.id = :movieId AND b.bookingStatus = 'PAID'")
        ...
        // Find all bookings that are pending and created before a certain time
        // (expired).
